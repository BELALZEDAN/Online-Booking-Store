...
if (
	...
	$target_cover_path = __DIR__ . '/../uploads/cover/';
	$target_file_path = __DIR__ . '/../uploads/files/';
	
	// Debugging
	var_dump($target_cover_path, $target_file_path);
	
	if (!file_exists($target_cover_path)) {
		die('Cover directory does not exist');
	}
